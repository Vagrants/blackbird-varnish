...
Summary: Get monitorring stats of varnish for blackbird
Name: %{name}
Version: %{version}
...
* Project Page: https://github.com/Vagrants/blackbird-varnish
...
cp -p varnish.cfg $RPM_BUILD_ROOT/%{blackbird_conf_dir}/varnish.cfg
...
%changelog
* Tue Feb 18 2014 makochi <makocchi@gmail.com> - 0.1.0-1
- first package
